              ...
              <div class="card">
                <div class="card-header">
                  <div class="row align-items-center">
                    <div class="col-md-8">
                      ...
                      $sql = "SELECT * FROM `withdraw` WHERE DATE_FORMAT(date, '%Y-%m') = '$dateFilter' ORDER BY withdraw_id DESC";
                ...
                <div class="card-body">
                  <table id="example1" class="table table-striped">
                    ...
                    <tbody>
                      <?php
                      $query = mysqli_query($conn, "SELECT * FROM `withdraw` WHERE DATE_FORMAT(date, '%Y-%m') = '$dateFilter' ORDER BY withdraw_id DESC");
                      if (mysqli_num_rows($query) > 0) {
                        while ($result = mysqli_fetch_array($query)) {
                          extract($result);
                      ?>
