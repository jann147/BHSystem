    ...
    <div class="content-wrapper">
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-3">
            <div class="col-sm-6">
              <h1>List of Female Room Available</h1>
            </div>
          </div>
        </div>
      </section>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <select id="selectname" class="form-control select2bs4" data-placeholder="Select Name" required name="tenanupdateID" style="width: 100%;">
                                    ...
                                    <?php
                                    $query = mysqli_query($conn, "SELECT * FROM `tenants` WHERE `gender`= 'Female' AND `status` = 0");
                                    while ($result = mysqli_fetch_array($query)) {
                                      extract($result);
                                    ?>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <select id="selectRoom" class="form-control select2bs4" data-placeholder="Select Room" required name="room_id" style="width: 100%;">
                                    ...
                                    $query = mysqli_query(
                                      $conn,
                                      "SELECT room.*, (room.maximum - COALESCE((SELECT COUNT(DISTINCT tenants.tenants_id)  FROM rent INNER JOIN tenants ON tenants.tenants_id = rent.tenants_id  WHERE rent.room_id = room.room_id), 0)) AS free_beds FROM `room`  WHERE room_status IS NULL AND roomgender = 'Female'  HAVING free_beds > 0"
                                    );
                                    while ($result = mysqli_fetch_array($query)) {
                                      extract($result);
                                    ?>
